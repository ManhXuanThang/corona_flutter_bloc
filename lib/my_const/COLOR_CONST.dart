import 'package:coronavirus_app/presentation/customeui/hex_color.dart';
import 'package:flutter/material.dart';
class COLOR_CONST {
  //https://gist.github.com/lopspower/03fb1cc0ac9f32ef38f4

  static final HexColor DEFAULT = new HexColor("#272E36");
  static final HexColor HOME_BACKGROUND = new HexColor("#121517");
  static final HexColor DEFAULT_5 = new HexColor("#707070");
  static final HexColor GREEN_HOME = new HexColor("#00C571");
  static final HexColor RED2 = new HexColor("#D05045");
  static final HexColor GREEN = new HexColor("#2EC492");
  static final HexColor GREEN2 = new HexColor("#5A45F8");
